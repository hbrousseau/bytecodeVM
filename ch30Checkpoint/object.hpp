...
#define IS_BOUND_METHOD(value) isObjType(value, OBJ_BOUND_METHOD) // added in ch28
...
#define AS_BOUND_METHOD(value) ((ObjBoundMethod*)AS_OBJ(value))        // added in ch28
...
typedef enum {
    OBJ_BOUND_METHOD, // added in ch28
...
// represents a bound method object
typedef struct { // added in ch28
    Obj         obj;
    Value       receiver;
    ObjClosure* method;
} ObjBoundMethod;
